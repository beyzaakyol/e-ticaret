		...
		<div class="container">
			<div class="row">
				<div class="col-xs-6 col-md-4 main-logo">
					<a href="index.php"><img width="70" height="100" src="<?php echo $ayarcek['ayar_logo'] ?>" alt="Site Logosu" class="logo img-responsive"></a>
				</div>
				...
				<div class="col-md-8">
					<div class="pushright">
						...
						<?php } else { ?>
							...
							<a href="#" class="btn btn-default btn-dark">Hoşgeldin <span>--</span><?php $kullanicicek['kullanici_adsoyad'] ?></a>
									...
									<div class="col-md-6 regform">
										...
										<form action="nedmin/netting/islem.php" method="POST" role="form">
											<div class="form-group">
												<input type="text" class="form-control" name="userkullanici_mail" id="username" placeholder="Kullanıcı Adınız (Mail Adresiniz)">
											</div> 
