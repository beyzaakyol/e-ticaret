        ...
        <div class="right_col" role="main">
          <div class="">
                ...
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    if (isset($_GET['durum'])=="ok") { ?>
                      ...
                      <?php } else if (isset($_GET['urun_durum'])=="no") {?>
                  ...
                  $kategorisor->execute(array(
                    ...
                    <select class="select2_multiple form-control" required="" name="kategori_id" >
                     ...
                     while($kategoricek=$kategorisor->fetch(PDO::FETCH_ASSOC)) {
                       ...
                       <option <?php if ($kategori_id==$urun_id) { echo "selected='select'"; } ?> 
            ...
            <!-- Ck Editör Bitiş -->
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Ürün Keyword <span >*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          ...
                          <!-- Kısa if Kullanımı --> 
                      <option value="1" <?php echo $uruncek['urun_durum']=='1' ? 'selected=""' : ''; ?>>Aktif
                      </option>

                      <option value="0" <?php if ($uruncek['urun_durum']==0) {echo 'selected=""';} ?>>Pasif
                      </option>
