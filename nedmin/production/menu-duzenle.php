                ...
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    if (isset($_GET['durum'])=="ok") { ?>
                      ...
                      <?php } else if (isset($_GET['menu_durum'])=="no") {?>
                  ...
                  <div class="x_content">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="first-name" name="menu_seourl" disabled="" value="<?php echo seo($menucek['menu_ad']) ?>/sayfa-<?php echo seo($menucek['menu_ad']) ?>" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
            ...
            <!-- Ck Editör Bitiş -->
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          ...
                          <!-- Kısa if Kullanımı --> 
                      <option value="1" <?php echo $menucek['menu_durum']=='1' ? 'selected=""' : ''; ?>>Aktif
                      </option>

                      <option value="0" <?php if ($menucek['menu_durum']==0) {echo 'selected=""';} ?>>Pasif
                      </option>
