					...
					<div class="col-md-4">
						<div class="productwrap">
							<div class="pr-img">
								...
								<div class="pricetag on-sale"><div class="inner on-sale"><span class="onsale"><span 
                class="oldprice"><?php echo $uruncek['urun_fiyat']*1.50 ?></span><small><?php echo $uruncek['urun_fiyat']?> TL</small></span></div></div>
							</div>
